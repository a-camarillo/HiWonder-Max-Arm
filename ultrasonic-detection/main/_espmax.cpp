...
float* inverse(float pos[3], float* ang){
    ...
    float r = sqrt(x*x + y*y) - L1 - L4; // Radius of Rotation
    z = z - L0;
    ...
    // The cosine theorem calculates the angle between each joint
    ...
    // Deflect the angle as needed. Here, the starting point of the chassis rotation is set to -120 degrees, and the coordinate system is rotated.
