...
// Macro function gets the lower eight bits of A
#define GET_HIGH_BYTE(A) (uint8_t)((A) >> 8)
// Macro function obtains the high eigth bits of A
#define BYTE_TO_HW(A, B) ((((uint16_t)(A)) << 8) | (uint8_t)(B))
// Macro function uses A as the upper eight bits and B as the lower eight bits to merge into a 16-bit integer
